...
{{senderName}}`,
    category: 'follow-up',
    variables: ['companyName', 'industryType', 'priorityScore', 'recoveryLikelihood', 'signalCount', 'senderName']
  },
  {
...
{{senderName}}`,
    ...
    variables: ['companyName', 'yearsSinceDefault', 'healthGrade', 'signalCount', 'mlConfidence', 'senderName']
  },
  {
...
{{senderName}}`,
    category: 'initial-outreach',
    variables: ['companyName', 'equipmentSignal', 'industryType', 'healthGrade', 'recoveryLikelihood', 'senderName']
  }
]
